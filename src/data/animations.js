...
export const ANIMATIONS = [
  ...
  // ---- 3D transformations ----------------------------------------------------------
  { id: 'perspective-tilt-3d', name: 'Perspective Tilt 3D', category: 'three-d', cssClassName: 'anim-perspective-tilt-3d', previewKind: 'interactive', suitableFor: ['card'], description: 'A pointer-responsive card tilts across both axes while its content rises toward the viewer.' },
  { id: 'flip-reveal-3d', name: 'Flip Reveal 3D', category: 'three-d', cssClassName: 'anim-flip-reveal-3d', previewKind: 'interactive', suitableFor: ['card', 'modal'], description: 'A two-sided surface rotates through depth to reveal its reverse face.' },
  { id: 'cube-transition-3d', name: 'Cube Transition 3D', category: 'three-d', cssClassName: 'anim-cube-transition-3d', previewKind: 'interactive', suitableFor: ['page', 'card'], description: 'Content moves between four faces of a spatial cube.' },
  { id: 'layered-depth-3d', name: 'Layered Depth 3D', category: 'three-d', cssClassName: 'anim-layered-depth-3d', previewKind: 'enter', suitableFor: ['page', 'card'], description: 'Interface layers separate along the Z axis and settle into a dimensional stack.' },
  { id: 'spatial-carousel-3d', name: 'Spatial Carousel 3D', category: 'three-d', cssClassName: 'anim-spatial-carousel-3d', previewKind: 'interactive', suitableFor: ['card', 'page'], description: 'Cards orbit through a perspective scene, bringing the selected item to the foreground.' },

  // ---- Data visualization motion --------------------------------------------------
  { id: 'kpi-counter-reveal', name: 'KPI Counter Reveal', category: 'data-motion', cssClassName: 'anim-kpi-counter-reveal', previewKind: 'enter', suitableFor: ['card', 'page'], description: 'Metric values roll upward through intermediate values before settling on the result.' },
  { id: 'bar-chart-grow', name: 'Bar Chart Grow', category: 'data-motion', cssClassName: 'anim-bar-chart-grow', previewKind: 'stagger', suitableFor: ['card', 'page'], description: 'Chart bars grow from the baseline in sequence to reveal a comparison.' },
  { id: 'line-chart-draw', name: 'Line Chart Draw', category: 'data-motion', cssClassName: 'anim-line-chart-draw', previewKind: 'enter', suitableFor: ['card', 'page'], description: 'A trend line is progressively uncovered from left to right.' },
  { id: 'donut-progress-reveal', name: 'Donut Progress Reveal', category: 'data-motion', cssClassName: 'anim-donut-progress-reveal', previewKind: 'stagger', suitableFor: ['card', 'page'], description: 'Circular progress segments appear in sequence around a central metric.' },
  { id: 'live-data-update', name: 'Live Data Update', category: 'data-motion', cssClassName: 'anim-live-data-update', previewKind: 'stagger', suitableFor: ['table', 'page'], description: 'Fresh data rows arrive with a restrained positional and opacity cue.' },
  { id: 'dashboard-filter-transition', name: 'Dashboard Filter Transition', category: 'data-motion', cssClassName: 'anim-dashboard-filter-transition', previewKind: 'stagger', suitableFor: ['card', 'page'], description: 'Filtered dashboard cards settle into the updated result set.' },

  // ---- Navigation / Menu motion ---------------------------------------------------
  { id: 'sidebar-expand-motion', name: 'Sidebar Expand Motion', category: 'navigation-motion', cssClassName: 'anim-sidebar-expand-motion', previewKind: 'interactive', suitableFor: ['page'], description: 'A navigation rail translates into view to reveal its full destinations.' },
  { id: 'mega-menu-reveal', name: 'Mega Menu Reveal', category: 'navigation-motion', cssClassName: 'anim-mega-menu-reveal', previewKind: 'interactive', suitableFor: ['page'], description: 'A structured mega menu settles beneath its trigger with restrained depth.' },
  { id: 'mobile-menu-morph', name: 'Mobile Menu Morph', category: 'navigation-motion', cssClassName: 'anim-mobile-menu-morph', previewKind: 'interactive', suitableFor: ['page', 'button'], description: 'A mobile navigation trigger morphs while its contained menu enters from the edge.' },
  { id: 'tab-indicator-slide', name: 'Tab Indicator Slide', category: 'navigation-motion', cssClassName: 'anim-tab-indicator-slide', previewKind: 'interactive', suitableFor: ['page', 'button'], description: 'An active indicator travels between equal-width tabs without moving their labels.' },
  { id: 'breadcrumb-transition', name: 'Breadcrumb Transition', category: 'navigation-motion', cssClassName: 'anim-breadcrumb-transition', previewKind: 'enter', suitableFor: ['page'], description: 'Breadcrumb context moves forward as the user navigates deeper into a hierarchy.' },
  { id: 'floating-dock-magnify', name: 'Floating Dock Magnify', category: 'navigation-motion', cssClassName: 'anim-floating-dock-magnify', previewKind: 'interactive', suitableFor: ['page', 'button'], description: 'Dock destinations lift and magnify to show focus and selection.' },

  // ---- Text / Brand motion --------------------------------------------------------
  { id: 'headline-mask-reveal', name: 'Headline Mask Reveal', category: 'text-brand-motion', cssClassName: 'anim-headline-mask-reveal', previewKind: 'enter', suitableFor: ['page'], description: 'A headline rises cleanly through a clipped baseline.' },
  { id: 'staggered-word-entrance', name: 'Staggered Word Entrance', category: 'text-brand-motion', cssClassName: 'anim-staggered-word-entrance', previewKind: 'stagger', suitableFor: ['page'], description: 'Words enter sequentially to shape the reading rhythm.' },
  { id: 'letter-by-letter-reveal', name: 'Letter-by-Letter Reveal', category: 'text-brand-motion', cssClassName: 'anim-letter-by-letter-reveal', previewKind: 'stagger', suitableFor: ['page'], description: 'Characters appear one after another for a precise branded reveal.' },
  { id: 'text-message-morph', name: 'Text Message Morph', category: 'text-brand-motion', cssClassName: 'anim-text-message-morph', previewKind: 'enter', suitableFor: ['page'], description: 'One short campaign message yields to another through position and opacity.' },
  { id: 'logo-piece-assembly', name: 'Logo Piece Assembly', category: 'text-brand-motion', cssClassName: 'anim-logo-piece-assembly', previewKind: 'stagger', suitableFor: ['page'], description: 'Individual brand-mark pieces converge into a finished identity.' },
  { id: 'announcement-ticker', name: 'Announcement Ticker', category: 'text-brand-motion', cssClassName: 'anim-announcement-ticker', previewKind: 'loop', suitableFor: ['page'], description: 'A continuous announcement line travels across a contained banner.' },
  { id: 'character-wave', name: 'Character Wave', category: 'text-brand-motion', cssClassName: 'anim-character-wave', previewKind: 'stagger', suitableFor: ['page', 'button'], description: 'Characters lift in a short wave to add celebratory emphasis.' },
  { id: 'quote-focus-reveal', name: 'Quote Focus Reveal', category: 'text-brand-motion', cssClassName: 'anim-quote-focus-reveal', previewKind: 'enter', suitableFor: ['page', 'card'], description: 'A testimonial settles into focus with restrained editorial motion.' },
  { id: 'numeric-headline-flip', name: 'Numeric Headline Flip', category: 'text-brand-motion', cssClassName: 'anim-numeric-headline-flip', previewKind: 'enter', suitableFor: ['page', 'card'], description: 'A large numeric statement flips upward into its final value.' },
  { id: 'cta-copy-emphasis', name: 'CTA Copy Emphasis', category: 'text-brand-motion', cssClassName: 'anim-cta-copy-emphasis', previewKind: 'interactive', suitableFor: ['page', 'button'], description: 'Call-to-action copy lifts forward to reinforce the next step.' },
]
